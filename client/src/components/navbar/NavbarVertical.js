    ...
    <div>
      <nav className="navbar">
        <ul className="navbar-nav">
          <li className="logo">
            <Link to="/simplyfi-throwaway" className="nav-link-logo">
              <svg
              ...
              <span className="link-text logo-text">Simplyfi</span>
            </Link>
          </li>
          <li className="nav-item nav-item1">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <span className="link-text">Simply Learn</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link1">
              ...
              <span className="link-text">Simply Ask</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link1">
              ...
              <span className="link-text">Simply Match</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link1">
              ...
              <span className="link-text">Simply Transact</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <span className="link-text">Chat Support</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link2">
          ...
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link nav-link2">
              ...
              <span className="link-text">Share to Friends!</span>
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/simplyfi-throwaway" className="nav-link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
              ...
              <span className="link-text">Download Financial Plan</span>
            </Link>
          </li>
        </ul>
      </nav>
